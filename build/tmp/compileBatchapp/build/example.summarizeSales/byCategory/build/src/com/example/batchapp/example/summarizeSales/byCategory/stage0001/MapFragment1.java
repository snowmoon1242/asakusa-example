...
/**
 * A mapper fragment for processing{@code [sales->CategorySummaryOperator.checkStore(operator#1827969289)]}.
 */
@TraceLocation(batchId = "example.summarizeSales", flowId = "byCategory", stageId = "stage0001", fragmentId = "1")@
